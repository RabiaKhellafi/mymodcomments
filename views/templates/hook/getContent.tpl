<!-- Je suis prêt à être configuré, mais il y a encore du travail à faire-->
...
<!-- on recuperte les informations saisie
 "Post" mode de reuperation des données saisie
 "Action" definis la destination des données ici c'est vide donc destination la page elle même
-->
